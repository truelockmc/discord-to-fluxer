...
from ui.widgets import make_panel, make_status_row
        ...
        def load():
            try:
                ...
                action = (
                    ...
                    if side == "discord"
                    else "load_fluxer_channels"
                )
                self._report_error(action, exc, f"Channel load error ({side})")
